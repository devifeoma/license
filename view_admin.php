    ...
    <div id="wrapper">
     ...
     <?php include('nav.php');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">View Administrators</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="" method="post" class="niceform">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
			  $puter = mysql_query("select * from admin") or die (mysql_error());
             ...
             echo"<tr class='odd gradeX'>
                                            ...
                                            <td class='center'><input type='checkbox' name='checkbox[]' value='$id' class='checkbox' /> Click to Select</td>
                                        </tr>";
			  }
			  ?>
